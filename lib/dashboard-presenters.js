...
export function collectionPresentation(aggregate = {}) {
  const methods = [
    { name:'Cash', value:amount(aggregate.cash_sales) },
    { name:'UPI 1', value:amount(aggregate.upi_1_sales) },
    { name:'UPI 2', value:amount(aggregate.upi_2_sales) },
    { name:'Card', value:amount(aggregate.card_sales) },
  ]
